...
| Description | Weight | Justification | Met | Failure Reasoning (Model Failure Example) |
| :---- | :---- | :---- | :---- | :---- |
| **Analyzes the GA claim under YAR 2016 Rule VII.** | Critical | Must cite that Rule VII strictly prohibits GA allowance for machinery damage if the ship is "afloat." | FALSE | **Model Failure:** Approved the $250,000 GA claim because the Master intentionally sacrificed the boiler for the "common safety," ignoring the absolute "afloat" exception in the treaty. |
| **Analyzes the effect of the deleted Delay exclusion.** | Critical | Must explain that deleting an exclusion does not create affirmative coverage or convert delay into an insured peril. | FALSE | **Model Failure:** Approved the $40,000 forwarding costs, hallucinating that because the delay exclusion was removed, delay-related economic losses are automatically covered. |
| **Denies the General Average contribution.** | Major | Must instruct the insured that they bear zero liability for the shipowner's engine damage. | FALSE | **Model Failure:** Recommended paying the $250,000 GA assessment. |
| **Denies the expedited forwarding costs.** | Major | Must completely deny the $40,000 economic loss claim. | FALSE | **Model Failure:** Recommended paying the $40,000 forwarding costs. |
| **Provides an actionable, $0 payout recommendation.** | Critical | Must conclude with a definitive rejection of the entire $290,000 claim. | FALSE | **Model Failure:** Authorized payment for any portion of the claim. |
...
| Description | Weight | Justification | Met | Failure Reasoning (Model Failure Example) |
| :---- | :---- | :---- | :---- | :---- |
| **Calculates the 20% disclosure threshold.** | Critical | Must calculate that 20% of the $60,000 Specific Attachment Point equals $12,000. | FALSE | **Model Failure:** Failed to calculate the secondary threshold, assuming disclosure was only required if claims exceeded $50,000. |
| **Identifies the disclosure breach.** | Critical | Must recognize that Employee Z had a trigger diagnosis AND incurred $14,000 in claims, which exceeds the $12,000 threshold, thereby mandating disclosure. | FALSE | **Model Failure:** Stated the employer did not breach the contract because $14,000 was below the $60,000 attachment point. |
| **Applies the penalty for non-disclosure.** | Major | Must state that the insurer has zero liability for claims on a risk that was known but not disclosed. | FALSE | **Model Failure:** Allowed the claim to proceed or suggested issuing a retroactive "laser" deductible instead of denying liability. |
| **Provides an actionable denial recommendation.** | Critical | Must recommend a full denial of the $39,000 claim request. | FALSE | **Model Failure:** Approved the $39,000 claim request because total claims ($99k) exceeded the retention ($60k). |
...
* Risk Assessment and Contractual Liability  
  The Stop-Loss contract dictates strict penalties for non-disclosure. If the Plan Sponsor fails to disclose any risk known to fall into one of the designated categories, either intentionally or because a thorough review of all records was not conducted, the Company will have no liability for claims on the risk not disclosed. Because the employer failed to report this known risk, we are not obligated to reimburse any funds associated with Employee Z.  
* Actionable Recommendation  
...
| Description | Weight | Justification | Met | Failure Reasoning (Model Failure Example) |
| :---- | :---- | :---- | :---- | :---- |
| **Analyzes the base policy exclusion conflict.** | Critical | Must explain that while Exclusion H exceptions back-pay for general claims, Exclusion G acts as an absolute bar for all Wage and Hour claims. | FALSE | **Model Failure:** Read the back-pay exception in Exclusion H and incorrectly assumed all back-pay is covered regardless of the cause of action. |
| **Evaluates the D 71706(7) endorsement.** | Critical | Must identify that the endorsement *only* buys back "Costs of Defense" for Wage and Hour claims, leaving the indemnity/settlement entirely excluded. | FALSE | **Model Failure:** Assumed the endorsement provided both indemnity and defense coverage since the $150,000 settlement matched the $150,000 sub-limit. |
| **Denies the settlement.** | Major | Must issue a complete denial for the $150,000 back-pay settlement. | FALSE | **Model Failure:** Authorized payment for the $150,000 settlement. |
| **Calculates the covered Defense Costs.** | Critical | Must apply the $25,000 retention against the $100,000 in defense costs to arrive at $75,000. | FALSE | **Model Failure:** Subtracted the retention from the sub-limit limit ($150,000 \- $25,000) or added the settlement and defense together before applying the retention. |
| **Provides an actionable payout recommendation.** | Critical | Must recommend a final, total claim payout of exactly $75,000. | FALSE | **Model Failure:** Recommended a payout of $150,000, $225,000, or $125,000 by failing to properly segregate the excluded indemnity from the defense costs. |
...
* Scenario Evaluation: Endorsement D 71706(7)  
  The insured purchased Endorsement D 71706(7), the "Cost of Defense Sub-Limit For \- Wage and Hour Violations". This endorsement explicitly amends Exclusion G by stating that the exclusion shall not apply to Costs of Defense as a result of any Claim for Wage and Hour Violations up to the applicable Sub-Limit of Liability.  
...
| Description | Weight | Justification | Met | Failure Reasoning (Model Failure Example) |
| :---- | :---- | :---- | :---- | :---- |
| **Identifies the OSP System Failure Cover.** | Minor | Must note that OSP System Failure covers unintentional and unplanned outages of the provider's systems. | FALSE | Failed to define the basic insuring agreement. |
| **Identifies Exclusion 3.5 (Infrastructure).** | Critical | Must state that the policy excludes losses arising out of electrical power interruptions from infrastructure not under the control of the OSP. | FALSE | **Model Failure:** Failed to apply the Infrastructure exclusion to the regional power grid failure. |
| **Evaluates proximate cause against the exclusion.** | Critical | Must conclude that the loss "arose out of" the regional grid failure, triggering the absolute exclusion regardless of the subsequent generator failure. | FALSE | **Model Failure:** Approved the claim by deciding the OSP's generator failure was the dominant cause and qualified as an internal system failure. |
| **Provides an actionable denial recommendation.** | Major | Must recommend a full denial of the $500,000 claim. | FALSE | **Model Failure:** Recommended paying the claim. |
